...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class XRSliderM : XRBaseInteractable
    {
        [Serializable]
        ...
        void SetSliderPosition(float value)
        {
            ...
            handlePos.y = Mathf.Lerp(m_MinPosition,value, m_MaxPosition);
        ...
        {
            var sliderMinPoint = transform.TransformPoint(new Vector3(0.0f, m_MinPosition, 0.0f));
            var sliderMaxPoint = transform.TransformPoint(new Vector3(0.0f, m_MaxPosition, 0.0f));
